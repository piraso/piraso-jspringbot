...
import org.piraso.api.jspringbot.JSpringBotRequestEntry;
...
public class JSpringBotRequestMessageProviderImpl extends AbstractMessageProvider {

    @Override
    public boolean isSupported(Entry entry) {
        return JSpringBotRequestEntry.class.isInstance(entry);
    }
