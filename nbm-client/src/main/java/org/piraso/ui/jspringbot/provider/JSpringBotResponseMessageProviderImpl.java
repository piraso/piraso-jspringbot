...
import org.piraso.api.jspringbot.JSpringBotResponseEntry;
...
public class JSpringBotResponseMessageProviderImpl extends AbstractMessageProvider {

    @Override
    public boolean isSupported(Entry entry) {
        return JSpringBotResponseEntry.class.isInstance(entry);
    }
